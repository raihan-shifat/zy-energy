...
class InstallApp extends Command
{
     ...
     * @var string
     */
    protected $signature = 'install:app {--locale= : Set the application locale} {--with-import : Import default data}';
     ...
     * @var string
     */
    protected $description = 'Install the ZY Energy eCommerce application.';
