...
class DataImport extends Command
{
    ...
    protected function createCategoriesAndProducts()
    {
        ...
        StoreSetting::insert([
            ...
            ['key' => 'meta_title', 'value' => 'Welcome to ZY Energy - Wind Turbines, Solar Panels & Energy Storage'],
            ['key' => 'meta_description', 'value' => 'ZY Energy is a manufacturer and exporter of wind turbines, solar panels, solar street lights, inverters, batteries and complete off-grid/on-grid system solutions.'],
