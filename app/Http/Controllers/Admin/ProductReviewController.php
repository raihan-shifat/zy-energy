...
class ProductReviewController extends Controller
{
    ...
    public function getData()
    {
        ...
        ->addColumn('action', function ($review) {
            $viewBtn = '<a href="'.route('admin.reviews.show', $review->id).'" class="btn btn-sm btn-info">View</a>';

            $deleteBtn = '<form action="'.route('admin.reviews.destroy', $review->id).'" method="POST" style="display:inline-block;">
    ...
    public function update(Request $request, ProductReview $review)
    {
        ...
        $review->update($request->only(['rating', 'review', 'is_approved']));
