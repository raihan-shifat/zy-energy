...
class CustomerController extends Controller
{
    ...
    public function getCustomerData()
    {
        ...
        ->addColumn('action', function ($customer) {
            $deleteBtn = '<span class="border border-danger dt-trash rounded-3 d-inline-block" onclick="deleteCustomer('.$customer->id.')"><i class="bi bi-trash-fill text-danger"></i></span>';
