...
class AttributeController extends Controller
{
    ...
    public function getAttributesData(Request $request)
    {
        ...
        ->addColumn('action', function ($attribute) {
            $editBtn = '<a href="'.route('admin.attributes.edit', $attribute->id).'" class="btn btn-sm btn-warning">Edit</a>';

            $deleteBtn = '<button class="btn btn-sm btn-danger" onclick="deleteAttribute('.$attribute->id.')">Delete</button>';
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->attributeService->deleteAttribute((int) $id);
