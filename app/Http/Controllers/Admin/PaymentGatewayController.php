...
class PaymentGatewayController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        ->addColumn('action', function ($row) {
            $editBtn = '<a href="'.route('admin.payment-gateways.edit', $row->id).'" class="btn btn-sm btn-primary me-1">
                    <i class="bi bi-pencil-fill"></i>
                </a>';

            $deleteBtn = '<span class="border border-danger dt-trash rounded-3 d-inline-block" onclick="deleteGateway('.$row->id.')">
