    ...
    public function getProductsForDataTable($request)
    {
        ...
        return DataTables::of($products)
            ...
            ->addColumn('action', function ($product) {
                $editBtn = '<a href="'.route('admin.products.edit', $product->id).'" class="btn btn-primary btn-sm">Edit</a>';

                $deleteBtn = '<form action="'.route('admin.products.destroy', $product->id).'" method="POST" class="d-inline" onsubmit="return confirm(\'Are you sure you want to delete this product?\');">
                    '.csrf_field().'
                    '.method_field('DELETE').'
