...
return [
    ...
    'footer' => [
        ...
        'maintained_by' => 'تم الإنشاء والصيانة بواسطة', 'quick_links' => 'روابط سريعة', 'home' => 'الرئيسية', 'products' => 'المنتجات',
        'news' => 'الأخبار', 'about' => 'من نحن', 'contact' => 'اتصل بنا', 'address' => 'العنوان', 'social_connect' => 'التواصل الاجتماعي',
        'wechat_qr_title' => 'امسح رمز WeChat', 'wechat_qr_hint' => 'افتح WeChat وامسح الرمز للتواصل مع فريقنا.',
    ],
    ...
    'home' => [
        ...
        'fast_delivery_title' => 'دعم OEM و ODM',
        'fast_delivery_text' => 'نقدم خدمات تصنيع OEM و ODM مرنة مع علامة تجارية وتصميم ومواصفات مخصصة حسب احتياجاتك.',
    ...
    'register' => [
        'hello' => 'مرحبًا',
        'theme_name' => 'ZY Energy 👋 منصّة زيلو',
        ...
        'copyright' => '© 2026 ZY Energy. جميع الحقوق محفوظة.',
    ...
    'contact' => [
        'contact_us' => 'اتصل بنا', 'wechat' => 'WeChat', 'whatsapp' => 'WhatsApp', 'email' => 'البريد الإلكتروني',
        'copy' => 'نسخ', 'copied' => 'تم النسخ!', 'send_email' => 'إرسال البريد', 'chat_now' => 'تحدث الآن',
        'subtitle' => 'تواصل مع فريقنا عبر WeChat أو WhatsApp أو البريد الإلكتروني.',
    ],
    'common' => ['close' => 'إغلاق', 'logout' => 'تسجيل الخروج', 'profile_alt' => 'الملف الشخصي', 'avatar_alt' => 'الصورة الرمزية', 'image_alt' => 'صورة'],
    'home_b2b' => [
        'hero_eyebrow' => 'طاقة الرياح · الطاقة الشمسية · التخزين', 'hero_title' => 'حلول الطاقة المتجددة للصناعة',
        'hero_subtitle' => 'توربينات الرياح والألواح الشمسية والعاكسات والبطاريات، مصممة للأداء وموردة إلى جميع أنحاء العالم.',
        'categories' => 'فئات المنتجات', 'categories_subtitle' => 'اكتشف مجموعتنا الكاملة من منتجات وحلول أنظمة الطاقة المتجددة.',
        'certifications' => 'الشهادات', 'latest_news' => 'آخر الأخبار', 'view_all_news' => 'عرض كل الأخبار',
        'view_all_products' => 'عرض كل المنتجات', 'get_quote' => 'احصل على عرض سعر',
        'get_quote_text' => 'هل تخطط لمشروع؟ تواصل مع فريق التصدير لدينا للحصول على عرض مخصص.',
        'contact_us' => 'اتصل بنا', 'send_enquiry' => 'إرسال استفسار', 'view_details' => 'عرض التفاصيل',
    ],
];
