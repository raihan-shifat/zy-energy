...
'success_update' => '产品评论更新成功！',
    ...
    'contact' => [
        'page_title' => '联系我们',
        'page_subtitle' => '我们在这里为您提供帮助。通过微信、WhatsApp 或电子邮件联系我们的团队。',
        'wechat_section_title' => '微信',
        'wechat_section_description' => '扫描二维码与我们聊天',
        'whatsapp_section_title' => 'WhatsApp',
        'whatsapp_section_description' => '直接在 WhatsApp 上与我们聊天',
        'email_section_title' => '电子邮件',
        'email_section_description' => '发送电子邮件以获取详细信息。',
        'bottom_message' => '我们的团队随时准备为您提供产品信息、报价、技术问题和业务咨询方面的帮助。',
        'response_time_text' => '我们的团队通常在 24 小时内回复。',
        'chat_now' => '立即聊天',
        'send_email' => '发送邮件',
        'copy' => '复制',
