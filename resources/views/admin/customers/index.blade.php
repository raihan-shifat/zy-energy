        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    var deleteBtn = isManager ? '' : '<span class="border border-danger dt-trash rounded-3 d-inline-block" onclick="deleteCustomer(' + row.id + ')"><i class="bi bi-trash-fill text-danger"></i></span>';
                    return deleteBtn;
                }
            }
        ],
