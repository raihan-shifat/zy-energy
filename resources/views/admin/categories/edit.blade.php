    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <label class="form-label">Sub-types (comma separated)</label>
                        <input type="text" name="types" class="form-control" value="{{ old('types', implode(', ', $category->types ?? [])) }}" placeholder="e.g. Horizontal, Vertical">
                        <small class="text-muted">Used for per-category type filter (e.g. Wind Turbine: Horizontal/Vertical). Leave empty if the category has no sub-types.</small>
                    </div>
                </div>
