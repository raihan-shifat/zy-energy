...
<div class="card mt-4">
    <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center">
        <h6 class="mb-0 dt-heading">Create WeChat Contact</h6>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.contact.wechat.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="wechat_id" class="form-control" value="{{ old('wechat_id') }}">
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="purpose" class="form-control" value="{{ old('purpose') }}" placeholder="e.g., Business Inquiries, After-Sales Support">
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <label class="form-label">WeChat ID</label>
                    <input type="text" name="wechat_id" class="form-control" value="{{ old('wechat_id') }}" placeholder="WeChat ID">
                </div>
            </div>
