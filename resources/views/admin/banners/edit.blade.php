                                ...
                                <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="languages[{{ $index }}][title]" 
                                               ...
                                               value="{{ old('languages.' . $index . '.title', $bannerTranslation->title ?? '') }}" {{ $language->code === 'en' ? 'required' : '' }}>
                                    ...
                                    <div class="form-group mt-2">
                                        <label>Subtitle (plain text)</label>
                                        <input type="text" name="languages[{{ $index }}][subtitle]"
                                               class="form-control"
                                               value="{{ old('languages.' . $index . '.subtitle', $bannerTranslation->subtitle ?? '') }}"
                                               placeholder="Plain text subtitle for the hero section">
                                    </div>

                                    <div class="form-group mt-2">
                                        <label>CTA Button Text</label>
                                        <input type="text" name="languages[{{ $index }}][cta_text]"
                                               class="form-control"
                                               value="{{ old('languages.' . $index . '.cta_text', $bannerTranslation->cta_text ?? '') }}"
                                               placeholder="e.g. View Products">
                                    </div>

                                    <div class="form-group mt-2">
                                        <label>CTA Link</label>
                                        <input type="text" name="languages[{{ $index }}][cta_link]"
                                               class="form-control"
                                               value="{{ old('languages.' . $index . '.cta_link', $bannerTranslation->cta_link ?? '') }}"
