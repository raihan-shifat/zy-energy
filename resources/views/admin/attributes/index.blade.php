            ...
            columns: [
                ...
                { data: 'values', name: 'values', orderable: false, searchable: false },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        var deleteBtn = isManager ? '' : '<span class="border border-danger dt-trash rounded-3 d-inline-block" onclick="deleteAttribute(' + row.id + ')"> <i class="bi bi-trash-fill text-danger"></i> </span>';
