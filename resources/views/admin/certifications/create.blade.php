...
<div class="card mt-4">
    <div class="card-header card-header-bg text-white">
        <h6 class="d-flex align-items-center mb-0 dt-heading">{{ __('cms.certifications.add_new') }}</h6>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.certifications.store') }}" method="POST" enctype="multipart/form-data" id="certificationForm">
            ...
            <button type="submit" class="mt-3 btn btn-primary">{{ __('cms.certifications.create') }}</button>
        </form>
    </div>
</div>
@endsection
